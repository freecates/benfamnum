...
export default () => (
    <Layout>
      <nav aria-label="Estás aquí:" role="navigation">
        ...
        <p>FEFN únicamente utiliza cookies técnicas, de personalización y análisis, propias y de terceros, que en ningún caso tratan datos de carácter personal ni captan hábitos de navegación para fines publicitarios.</p>
