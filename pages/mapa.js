...
const MapByCategory = (props) => (
  <Layout>
    ...
    <p className='align-center'><small><Link  as={`/c/${props.markers[0].categoria_de_la_prestacion.term_id}/${props.markers[0].categoria_de_la_prestacion.slug}`} href={`/category?sid=${props.markers[0].categoria_de_la_prestacion.term_id}`}><a>ver listado</a></Link></small></p>
       ...
       <GoogleMapReact
        ...
        {props.markers.map((marker, index) => (
          ...
          <MarkerComponent
            ...
            text={<Link  href={`/p/${marker.ID}/${marker.slug}`}><a title={marker.name}><span><img src={'/static/32/' + props.markers[0].categoria_de_la_prestacion.slug +'-familias-numerosas.png'} /></span></a></Link>}
          />
              ))}
        </GoogleMapReact>
