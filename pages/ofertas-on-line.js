...
const OfertasOnLine = ({ ofertasonlines }) => (
  <Layout>
    <Head>
      ...
      <main>
        ...
        <section>
          ...
          <ul className="gallery">
            {ofertasonlines.reduce((categories, ofertasonline) => {
...
export async function getStaticProps() {
  const res = await fetch(
    'https://gestorbeneficios.familiasnumerosas.org/wp-json/lanauva/v1/ofertas_online?sim-model=categoria'
  );
